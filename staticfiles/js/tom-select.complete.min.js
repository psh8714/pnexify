...
!function (e, t) {
    ...
    const i = e => (e = e.filter(Boolean)).length < 2 ? e[0] || "" : 1 == l(e) ? "[" + e.join("") + "]" : "(?:" + e.join("|") + ")",
        s = e => {
            ...
            let t = Array.from(e)
            return i(t)
        }, o = e => new Set(e).size !== e.length, r = e => (e + "").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu, "\\$1"),
        l = e => e.reduce((e, t) => Math.max(e, a(t)), 0), a = e => Array.from(e).length, c = e => {
    ...
    const f = new RegExp(Object.keys(h).join("|") + "|[̀-ͯ·ʾʼ]", "gu"), m = (e, t = "NFKD") => e.normalize(t),
        v = e => Array.from(e).reduce((e, t) => e + O(t), ""),
        O = e => (e = m(e).toLowerCase().replace(f, e => h[e] || ""), m(e, "NFC"))
    const b = e => {
        const t = {}, i = (e, i) => {
    ...
    class T {
        ...
        tokenize(e, t, i) {
            ...
            return i && (o = new RegExp("^(" + Object.keys(i).map(r).join("|") + "):(.*)$")), n.forEach(e => {
                let i, n = null, l = null
                o && (i = e.match(o)) && (n = i[1], e = i[2]), e.length > 0 && (l = this.settings.diacritics ? x(e) || null : r(e), l && t && (l = "\\b" + l)), s.push({
                    string: e,
        ...
        _getSortFunction(e) {
            ...
            return i.length ? function (e, t) {
                var s, n
                for (let o of i) {
                    if (n = o.field, s = ("desc" === o.direction ? -1 : 1) * E(r(n, e), r(n, t))) return s
                }
                return 0
            } : null
        }
    ...
    const P = e => null == e ? null : N(e), N = e => "boolean" == typeof e ? e ? "1" : "0" : e + "",
        D = e => (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"),
        V = (e, t) => {
            var i
            return function (s, n) {
                var o = this
        ...
        R = (e, t) => !!t && (!!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0)),
        H = (e, t) => {
            const i = e.getAttribute("id")
            return i || (e.setAttribute("id", t), t)
        }, M = e => e.replace(/[\\"']/g, "\\$&"), z = (e, t) => {
            t && e.append(t)
        }, B = (e, t) => {
            if (Array.isArray(e)) e.forEach(t)
            else for (var i in e) e.hasOwnProperty(i) && t(e[i], i)
    ...
    function le(e, t) {
        var i = Object.assign({}, re, t), s = i.dataAttr, n = i.labelField, o = i.valueField, r = i.disabledField,
            l = i.optgroupField, a = i.optgroupLabelField, c = i.optgroupValueField, d = e.tagName.toLowerCase(),
        ...
        return "select" === d ? (() => {
            ...
            p.maxItems = e.hasAttribute("multiple") ? null : 1, B(e.children, e => {
                var i, s, n
                "optgroup" === (t = e.tagName.toLowerCase()) ? ((n = f(i = e))[a] = n[a] || i.getAttribute("label") || "", n[c] = n[c] || h++, n[r] = n[r] || i.disabled, n.$order = n.$order || ++g, p.optgroups.push(n), s = n[c], B(i.children, e => {
                    m(e, s)
                })) : "option" === t && m(e)
            })
        })() : (() => {
            const t = e.getAttribute(s)
            if (t) p.options = JSON.parse(t), B(p.options, e => {
                p.items.push(e[o])
            })
            else {
    ...
    class ce extends (function (e) {
        ...
        constructor(e, t) {
            ...
            const r = K("<div>"), l = K("<div>"), a = this._render("dropdown"),
                c = K('<div role="listbox" tabindex="-1">'), d = this.input.getAttribute("class") || "", u = n.mode
            var p
            if (Q(r, n.wrapperClass, d, u), Q(l, n.controlClass), z(r, l), Q(a, n.dropdownClass, u), n.copyClassesToDropdown && Q(a, d), Q(c, n.dropdownContentClass), z(a, c), K(n.dropdownParent || r).appendChild(a), G(n.controlInput)) {
                p = K(n.controlInput)
                B(["autocorrect", "autocapitalize", "autocomplete", "spellcheck", "aria-label"], e => {
                    s.getAttribute(e) && ie(p, {[e]: s.getAttribute(e)})
        ...
        setup() {
            const e = this, t = e.settings, i = e.control_input, s = e.dropdown, n = e.dropdown_content, o = e.wrapper,
                l = e.control, a = e.input, c = e.focus_node, d = {passive: !0}, u = e.inputId + "-ts-dropdown"
            ie(n, {id: u}), ie(c, {
                role: "combobox",
            ...
            const p = H(c, e.inputId + "-ts-control"),
                h = "label[for='" + (e => e.replace(/['"\\]/g, "\\$&"))(e.inputId) + "']",
                g = document.querySelector(h), f = e.focus.bind(e)
            if (g) {
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && ie(a, {multiple: "multiple"}), t.placeholder && ie(i, {placeholder: t.placeholder}), !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = V(t.load, t.loadThrottle)), q(s, "mousemove", () => {
                e.ignoreHover = !1
            }), q(s, "mouseenter", t => {
                ...
                i && (e.onOptionSelect(t, i), $(t, !0))
            }), q(l, "click", t => {
                var s = Z(t.target, "[data-ts-item]", l)
                s && e.onItemSelect(t, s) ? $(t, !0) : "" == i.value && (e.onClick(), $(t, !0))
            ...
            const m = t => {
                ...
                n == i && e.isOpen ? t.stopPropagation() : $(t, !0)
            }, v = () => {
                e.isOpen && e.positionDropdown()
            }, O = () => {
                e.isValid && (e.isValid = !1, e.isInvalid = !0, e.refreshState())
            }
            q(a, "invalid", O), q(document, "mousedown", m), q(window, "scroll", v, d), q(window, "resize", v, d), this._destroy = () => {
                a.removeEventListener("invalid", O), document.removeEventListener("mousedown", m), window.removeEventListener("scroll", v), window.removeEventListener("resize", v), g && g.removeEventListener("click", f)
            }, this.revertSettings = {
                innerHTML: a.innerHTML,
                tabIndex: a.tabIndex
            }, a.tabIndex = -1, a.insertAdjacentElement("afterend", e.wrapper), e.sync(!1), t.items = [], delete t.optgroups, delete t.options, e.refreshItems(), e.close(!1), e.inputState(), e.isSetup = !0, e.on("change", this.onChange), Q(a, "tomselected", "ts-hidden-accessible"), e.trigger("initialize"), !0 === t.preload && e.preload()
        }

        setupOptions(e = [], t = []) {
            this.addOptions(e), B(t, e => {
        ...
        onPaste(e) {
            var t = this
            t.isInputHidden || t.isLocked ? $(e) : t.settings.splitOn && setTimeout(() => {
                var e = t.inputValue()
        ...
        onKeyPress(e) {
            ...
            if (!t.isLocked) {
                ...
                return t.settings.create && "multi" === t.settings.mode && i === t.settings.delimiter ? (t.createItem(), void $(e)) : void 0
            }
            $(e)
        }
        ...
        onKeyDown(e) {
            ...
            if (t.ignoreHover = !0, t.isLocked) 9 !== e.keyCode && $(e)
                ...
                switch (e.keyCode) {
                    case 65:
                        if (R(oe, e) && "" == t.control_input.value) return $(e), void t.selectAll()
                        break
                    case 27:
                        return t.isOpen && ($(e, !0), t.close()), void t.clearActiveItems()
                    case 40:
                    ...
                    case 38:
                        ...
                        return void $(e)
                    case 13:
                        return void (t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), $(e)) : (t.settings.create && t.createItem() || document.activeElement == t.control_input && t.isOpen) && $(e))
                    case 37:
                        return void t.advanceSelection(-1, e)
                    case 39:
                        return void t.advanceSelection(1, e)
                    case 9:
                        return void (t.settings.selectOnTab && (t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), $(e)) : t.settings.create && t.createItem() && $(e)))
                    case 8:
                    case 46:
                        return void t.deleteSelection(e)
                }
                t.isInputHidden && !R(oe, e) && $(e)
            }
        }
        ...
        onInput(e) {
            ...
            this.lastValue !== t && (this.lastValue = t, "" != t ? (this.refreshTimeout && window.clearTimeout(this.refreshTimeout), this.refreshTimeout = ((e, t) => t > 0 ? window.setTimeout(e, t) : (e.call(null), null))(() => {
        ...
        onOptionSelect(e, t) {
            ...
            t.parentElement && t.parentElement.matches("[data-disabled]") || (t.classList.contains("create") ? s.createItem(null, () => {
                s.settings.closeAfterSelect ? s.close() : s.settings.clearAfterSelect && s.setTextboxValue()
            }) : void 0 !== (i = t.dataset.value) && (s.isDropdownContentStale = s.settings.hideSelected, s.addItem(i), s.settings.closeAfterSelect ? s.close() : s.settings.clearAfterSelect && s.setTextboxValue(), !s.settings.hideSelected && e.type && /click/.test(e.type) && s.setActiveOption(t)))
        }
        ...
        onItemSelect(e, t) {
            var i = this
            return !i.isLocked && "multi" === i.settings.mode && ($(e), i.setActiveItem(t, e), !0)
        }
        ...
        setActiveOption(e, t = !0) {
            e !== this.activeOption && (this.clearActiveOption(), e && (this.activeOption = e, ie(this.focus_node, {"aria-activedescendant": e.getAttribute("id")}), ie(e, {"aria-selected": "true"}), Q(e, "active"), t && this.scrollToOption(e)))
        }

        scrollToOption(e, t) {
            if (!e) return
            const i = this.dropdown_content, s = i.clientHeight, n = i.scrollTop || 0, o = e.offsetHeight,
        ...
        clearActiveOption() {
            this.activeOption && (J(this.activeOption, "active"), ie(this.activeOption, {"aria-selected": null})), this.activeOption = null, ie(this.focus_node, {"aria-activedescendant": null})
        }
        ...
        selectAll() {
            ...
            t.length && (e.inputState(), e.close(), e.activeItems = t, B(t, t => {
        ...
        getSearchOptions() {
            ...
            return "string" == typeof e.sortField && (t = [{field: e.sortField}]), {
        ...
        refreshOptions(e = !0) {
            ...
            for (t = 0; t < n; t++) {
                ...
                for (h.settings.hideSelected || d.classList.toggle("selected", h.items.includes(a)), o = l[h.settings.optgroupField] || "", i = 0, s = (r = Array.isArray(o) ? o : [o]) && r.length; i < s; i++) {
                    ...
                    const [s, a] = y(o, e)
                    i > 0 && (d = d.cloneNode(!0), ie(d, {
                        id: l.$id + "-clone-" + i,
                        "aria-selected": null
                    }), d.classList.add("ts-cloned"), J(d, "active"), h.activeOption && h.activeOption.dataset.value == n && c && c.dataset.group === o.toString() && (v = d)), a.appendChild(d), "" != o && (u[o] = s)
                }
            }
            var S
            ...
            }), b.innerHTML = "", z(b, l), h.isDropdownContentStale = !1, h.settings.highlight && (S = b.querySelectorAll("span.highlight"), Array.prototype.forEach.call(S, function (e) {
                var t = e.parentNode
                t.replaceChild(e.firstChild, e), t.normalize()
            }), m.query.length && m.tokens.length && B(m.tokens, e => {
                ne(b, e.regex)
            }))
            var _ = e => {
        ...
        removeOption(e, t) {
            const i = this
            e = N(e), i.uncacheValue(e), delete i.userOptions[e], delete i.options[e], i.isDropdownContentStale = !0, i.trigger("option_remove", e), i.removeItem(e, t)
        }
        ...
        addItem(e, t) {
            j(this, t ? [] : ["change", "dropdown_close"], () => {
                var i, s
        ...
        createItem(e = null, t = () => {
            ...
            if (e = e || s.inputValue(), !s.canCreate(e)) {
                return P(e) && this.options[e] && s.addItem(e), t(), !1
            }
            s.lock()
            var o = !1, r = e => {
        ...
        updateOriginalInput(e = {}) {
            ...
            if (t.is_select_tag) {
                ...
                function l(e, i, s) {
                    return e || (e = K('<option value="' + D(i) + '">' + D(s) + "</option>")), e != n && t.input.append(e), o.push(e), (e != n || r > 0 || "multi" == t.settings.mode) && (e.selected = !0), e
                }
                ...
                t.input.querySelectorAll("option:checked").forEach(e => {
                    ...
                    if (i = t.options[e], s = i[t.settings.labelField] || "", o.includes(i.$option)) {
                        l(t.input.querySelector(`option[value="${M(e)}"]:not(:checked)`), e, s)
        ...
        open() {
            var e = this
            e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, ie(e.focus_node, {"aria-expanded": "true"}), e.refreshState(), W(e.dropdown, {
                visibility: "hidden",
                display: "block"
            }), e.positionDropdown(), W(e.dropdown, {
                visibility: "visible",
                display: "block"
        ...
        positionDropdown() {
            if ("body" === this.settings.dropdownParent) {
                var e = this.control, t = e.getBoundingClientRect(), i = e.offsetHeight + t.top + window.scrollY,
        ...
        render(e, t) {
            ...
            if (s = K(s), "option" === e || "option_create" === e ? t[n.settings.disabledField] ? ie(s, {"aria-disabled": "true"}) : ie(s, {"data-selectable": ""}) : "optgroup" === e && (i = t.group[n.settings.optgroupValueField], ie(s, {"data-group": i}), t.group[n.settings.disabledField] && ie(s, {"data-disabled": ""})), "option" === e || "item" === e) {
                const i = N(t[n.settings.valueField])
                ie(s, {"data-value": i}), "item" === e ? (Q(s, n.settings.itemClass), ie(s, {"data-ts-item": ""})) : (Q(s, n.settings.optionClass), ie(s, {
                    role: "option",
                    id: t.$id
    ...
    return ce.define("change_listener", function () {
        q(this.input, "change", () => {
            this.sync()
        })
        ...
        t.hook("after", "setupTemplates", () => {
            ...
            if (s.classList.contains("selected")) return s.classList.remove("selected"), t.removeItem(s.dataset.value), t.refreshOptions(), void $(e, !0)
            i.call(t, e, s), o(s)
        })
        ...
        t.on("initialize", () => {
            ...
            e.addEventListener("click", e => {
                t.isLocked || (t.clear(), "single" === t.settings.mode && t.settings.allowEmptyOption && t.addItem(""), t.refreshOptions(!1), e.preventDefault(), e.stopPropagation())
        ...
        e.hook("after", "setupTemplates", () => {
            ...
            e.settings.render.item = (i, o) => {
                ...
                return q(r, "mousedown", e => {
                    n || $(e), e.stopPropagation()
                }), q(r, "dragstart", e => {
                    s = r, setTimeout(() => {
                        r.classList.add("ts-dragging")
                    }, 0)
                }), q(r, "dragenter", l), q(r, "dragover", l), q(r, "dragleave", () => {
        ...
        e.settings.shouldOpen = !0, e.hook("before", "setup", () => {
            ...
            }), q(e.control_input, "blur", () => e.onBlur()), e.hook("before", "close", () => {
        ...
        const t = this, i = Object.assign({
            label: "×", title: "Remove", className: "remove", tabindex: -1, role: "button", html: e => {
                var t
                const i = document.createElement("div")
                return i.className = e.className || "", i.title = e.title || "", i.setAttribute("role", e.role || "button"), i.tabIndex = null != (t = e.tabindex) ? t : -1, i.textContent = e.label || "", i
            }
        }, e)
        t.hook("after", "setupTemplates", () => {
            var e = t.settings.render.item
            t.settings.render.item = (s, n) => {
                var o = K(e.call(t, s, n)), r = K(i.html(i))
                return o.appendChild(r), q(r, "mousedown", e => {
                    $(e, !0)
                }), q(r, "click", e => {
                    t.isLocked || ($(e, !0), t.isLocked || t.shouldDelete([o], e) && (t.removeItem(o), t.refreshOptions(!1), t.inputState()))
                }), o
            }
        })
        ...
        const h = t => !(null !== e.settings.maxOptions && "number" == typeof e.settings.maxOptions && n.children.length >= e.settings.maxOptions) && !(!(t in l) || !l[t]),
            g = (t, i) => e.items.indexOf(i) >= 0 || c.indexOf(i) >= 0
        e.setNextUrl = (e, t) => {
            l[e] = t
        }, e.getUrl = t => {
            if (t in l) {
            ...
            if (!a) return i.call(e)
        }), e.hook("instead", "canLoad", i => i in l ? h(i) : t.call(e, i)), e.hook("instead", "loadCallback", (t, i) => {
            if (a) {
                if (o) {
                    const i = t[0]
                ...
                const t = "" !== e.lastValue ? (t, i) => e.items.indexOf(i) >= 0 || p.indexOf(i) >= 0 : g
                e.clearOptions(t)
            }
            s.call(e, t, i), a || d || (d = !0, "" === e.lastValue && (c = Object.keys(e.options), r = l[""], u = Object.values(e.options))), a = !1
        }), e.hook("before", "refreshOptions", () => {
            e.activeOption && "option" !== e.activeOption.getAttribute("role") && e.setActiveOption(e.activeOption.previousElementSibling)
        ...
        const f = () => {
            d && (e.addOptions(u), e.clearOptions(g), r && (l[""] = r))
        }
        e.on("type", t => {
            "" === t && (f(), e.refreshOptions(!1))
        }), e.on("dropdown_close", f), e.on("initialize", () => {
            p = Object.keys(e.options), c = Object.keys(e.options), n = e.dropdown_content, e.settings.render = Object.assign({}, {
                ...
                e.settings.shouldLoadMore.call(e) && h(e.lastValue) && (a || (a = !0, e.load.call(e, e.lastValue)))
            })
        })
    }), ce
})
